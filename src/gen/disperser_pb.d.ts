...
export class AuthenticatedRequest extends jspb.Message {
  ...
  clearDisperseRequest(): AuthenticatedRequest;
  ...
  clearAuthenticationData(): AuthenticatedRequest;
...
export class AuthenticatedReply extends jspb.Message {
  ...
  clearBlobAuthHeader(): AuthenticatedReply;
  ...
  clearDisperseReply(): AuthenticatedReply;
...
export class DisperseBlobRequest extends jspb.Message {
  ...
  clearCustomQuorumNumbersList(): DisperseBlobRequest;
  addCustomQuorumNumbers(value: number, index?: number): DisperseBlobRequest;
...
export class BlobInfo extends jspb.Message {
  ...
  clearBlobVerificationProof(): BlobInfo;
...
export class BlobHeader extends jspb.Message {
  ...
  clearBlobQuorumParamsList(): BlobHeader;
...
export class BlobVerificationProof extends jspb.Message {
  ...
  clearBatchMetadata(): BlobVerificationProof;
...
export class BatchMetadata extends jspb.Message {
  ...
  clearBatchHeader(): BatchMetadata;
